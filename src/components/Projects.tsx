...
export default function Projects() {
  ...
  // Fetch actual GitHub API stats for Harika1234-git
  useEffect(() => {
    let active = true;
    const fetchGitStats = async () => {
      try {
        const response = await fetch('https://api.github.com/users/Harika1234-git');
  ...
  // LeetCode solved metrics matching her user ID "BANDLA"
 const leetCodeStats = {
  username: 'HARIKA_BANDLA02',
  ...
  profileUrl: 'https://leetcode.com/u/HARIKA_BANDLA02/'
